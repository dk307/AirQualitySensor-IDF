...
constexpr const std::array<sensor_definition_display, 1> no_level{
    sensor_definition_display{-999, 999, 0},
};

constexpr const std::array<sensor_definition_display, 6> pm_2_5_definition_display{
...
constexpr const std::array<sensor_definition_display, 1> pm_1_definition_display{
    sensor_definition_display{-999, 999, 0},
};

constexpr const std::array<sensor_definition_display, 1> pm_4_definition_display{
    sensor_definition_display{-999, 999, 0},
};

constexpr const std::array<sensor_definition_display, 1> voc_definition_display{
    sensor_definition_display{-99, 99, 0},
};

constexpr const std::array<sensor_definition_display, 6> pm_10_definition_display{
...
constexpr const std::array<sensor_definition_display, 3> co2_definition_display{
    sensor_definition_display{0, 1000, 0},
    sensor_definition_display{1000, 1500, 1},
    sensor_definition_display{1500, 2000, 2},
};

constexpr const std::array<sensor_definition_display, 5> temperature_definition_display{
...
constexpr const std::array<sensor_definition_display, 4> humidity_definition_display{
